 ...
 * lands in Phase 3.
 *
 * @param nameLabel user-assigned name; null until the user names the person.
 * @param relationship user-assigned relationship key; used as the display label when no name is
 * set. Null until the user picks one.
